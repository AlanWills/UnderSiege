...
{
    public class ShowAndActivateObjectScript : Script
    {
        ...
        public ShowAndActivateObjectScript(BaseObject objectToSelect, bool shouldUpdateGame = true, bool canRun = true)
