    ...
    public class ShipAddOnAbilityUI : Menu
    {
        ...
        private void AddUI()
        {
            ...
            foreach (AddOnAbility ability in ParentShipAddOn.Abilities)
            {
                ...
                abilityImage.ScreenHoverUI = new Label(ability.AddOnAbilityData.DisplayName, new Vector2(0, Size.Y * 0.5f + SpriteFont.LineSpacing * 0.5f), Color.White, abilityImage);
